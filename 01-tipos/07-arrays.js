let animales = ['leon', 'gato'];
// cuando se muestra en pantalla respeta el orden
...
console.log(animales);
animales[10] = 'caballo';
console.log(animales[1]); // devolvera un valor null
console.log(typeof animales); // devuelve un object
console.log(animales.length); // devuelve la cantidad de elementos
